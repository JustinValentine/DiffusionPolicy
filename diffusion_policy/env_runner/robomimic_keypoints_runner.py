...
def create_env(env_meta, shape_meta, enable_render=True):
    ...
    env_kwargs["controller_configs"]['input_min'] = -10
    env_kwargs["controller_configs"]['output_min'] = -10
    env_kwargs["controller_configs"]['input_max'] = 10
    env_kwargs["controller_configs"]['output_max'] = 10


    env_class = RobosuiteKpWrapper
...
class RobomimicKeypointsRunner(BaseRunner):
    ...
    def __init__(self, 
        ...
        if abs_action:
            raise NotImplementedError("abs action not supported for keypoints")
        ...
        with h5py.File(dataset_path, 'r') as f:
            for i in range(n_train):
                ...
                def init_fn(env, init_state=init_state, 
                    ...
                    assert isinstance(env.env.env, RobomimicKPWrapper)
